<x-compementHome title="Conatct ENSIAD">
    ...
    <section class="_pl_rt">
        ...
        <div class="container col-12">
            <div class="col-12">
                <h1 style="text-align: center;">École Nationale Supérieure de l'Intelligence Artificielle et Sciences des Données</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="_lo_we_ds">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="_ol_we_as">
                                    <ol>
                                        <li><i class="far fa-location"></i><h3>Adresse </h3>F4VM+7CW, Taroudant</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="_ol_we_as">
                                    <ol>
                                        <li><i class="far fa-envelope"></i><h3>Email</h3>ensiasd@gmail.com</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="_ol_we_as">
                                    <ol>
                                        <li><i class="fas fa-mobile-alt"></i><h3>Tel</h3>0000000000</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-12">
                <div class="form-group">
                  ...
                  <input id="nom" name="name" class="form-control _ge_de_ol" type="text" placeholder="Entrer Nom" required="" aria-required="true">
                  <h6 id="Nomerror"></h6>
                </div>
              </div>
              ...
              <div class="col-lg-6 col-12">
                <div class="form-group">
                  ...
                  <input id="subject" name="subject" class="form-control _ge_de_ol" type="text" placeholder="Entrer Sujet" required="" aria-required="true">
              ...
              <div class="col-lg-6 col-12">
                <div class="form-group">
                  ...
                  <input id="phone" name="phone" class="form-control _ge_de_ol" type="text" placeholder="phone nomber" required="" aria-required="true">
                  <h6 id="phoneerror"></h6>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea id="message" name="message" class="form-control required" rows="5" placeholder="Ent le Message" aria-required="true"></textarea>
